...
return {
  ...
  fields = {
    ...
    { config = {
      ...
      fields = {
        ...
        { provision_key = { type = "string", unique = true, auto = true }, },
  ...
  entity_checks = {
    { at_least_one_of = {
        "config.enable_authorization_code", "config.enable_implicit_grant",
        "config.enable_client_credentials", "config.enable_password_grant",
    }, },
    { conditional = {
        if_field = "config.mandatory_scope",
        if_match = { eq = "redis" },
        then_field = "config.scopes",
